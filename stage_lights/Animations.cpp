...
static void Animations::sparkle(CRGB* leds, int red, int green, int blue, int delayDuration) {
...
static void Animations::sparkle(CRGB leds[NB_ARRAYS][NUM_LEDS], int red, int green, int blue, int delayDuration, unsigned long millisecs) {
  static unsigned long SparklePreviousMillis = 0;
  int pixel[NB_ARRAYS];
