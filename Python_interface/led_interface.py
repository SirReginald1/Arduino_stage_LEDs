...
class MainWindow(ttk.Frame):
    def __init__(self, master_window):
        ...
        main_frame.grid(column=2)
        instruction = ttk.Label(main_frame, text=instruction_text, width=50)
...
if __name__ == "__main__":
    ...
    app = ttk.Window("LED Controle Panel", "superhero", resizable=(True, True))
    MainWindow(app)
    app.mainloop()
